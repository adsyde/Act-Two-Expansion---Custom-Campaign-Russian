...
| Строк в моде | 4987 |
| Переведено | **1402 (28.1%)** |

Перевод выходит частями. Строки, до которых очередь ещё не дошла, игра
показывает по-английски — играть можно на любой стадии готовности.
